...
> *"Physics and mathematics were never just school subjects — they were the lens through which I saw the world."*
...
B.Tech in **Electrical & Computer Engineering** (SRM IST). Currently a **Market Analyst at Siemens**, building automation pipelines and predictive models for railway electrification markets. My work spans clinical ML, transit data engineering, and computer vision.
...
- Applied **PCA** for dimensionality reduction; comparatively evaluated **Random Forest, SVM, and Neural Networks** via cross-validation and hyperparameter tuning
- Deployed through a **clinical web interface**; granted institutional ethical clearance (SRM Medical Council, valid 3 years)
...
Biometric pipeline with **minutiae-based feature extraction** using Python + OpenCV.
- Designed for robust matching under degraded image conditions
- Investigated impact of data quality and feature engineering on biometric system performance

`Python` `OpenCV` `Feature Engineering`
...
**Market Analyst — Siemens** *(Jul 2024 – Present · Chennai)*
Built Python-based automation pipelines for data acquisition and transformation across large-scale industrial datasets. Developed Power BI dashboards and predictive models to support Go/No-Go decisions on electrification projects.
...
- 🥇 National recognition — regional science exhibition (pre-university)
- 🟡 HackerRank SQL — 5 stars
- 🎓 Performance Scholarship — SRM IST, 3 consecutive years (2021–2023)
- 📊 9.35 GPA
